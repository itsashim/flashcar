...
class SubscriptionController extends Controller
{
    ...
    {
        //  $this->middleware('permission:subscription-view', ['only' => ['index','showorderpage']]);
    ...
    public function showorderpage($id)
    {
        ...
        return view("front.showorderpage")->with("packageid", $id)->with("department", $department)->with("subscription", $subscription)->with("payment", $payment)->with("token", $token)->with("setting", $setting)->with('brands',$brands)->with('categories',$categories)->with('topadds',$topadds);
    }
