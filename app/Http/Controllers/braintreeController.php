...
class braintreeController extends Controller
{
    ...
    {
         $this->middleware('permission:braintree-view', ['only' => ['index','show']]);
         $this->middleware('permission:braintree-create', ['only' => ['create','store']]);
         $this->middleware('permission:braintree-edit', ['only' => ['edit','update']]);
         $this->middleware('permission:braintree-delete', ['only' => ['destroy']]);
    }
