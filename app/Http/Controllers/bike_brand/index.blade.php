         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                  ...
                  @endif
                  <div>
                     <a href="{{url('admin/category/create')}}" class="btn btn-primary">{{__('messages.Add').' Category'}}</a>
                  </div>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="btn-group" role="group">
                                 ...
                                 @if(!$subCategory)
                                    <a data-url="{{  route('category.destroy',[$d->id])  }}" data-id="{{  $d->id  }}" class="btn btn-danger rowDelete">
