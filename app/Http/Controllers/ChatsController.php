...
use App\Events\FormSubmitted;
    ...
    {
         $this->middleware('permission:chats-view', ['only' => ['index','showchat']]);
         $this->middleware('permission:chats-create', ['only' => ['createchannel','store']]);
         $this->middleware('permission:chats-edit', ['only' => ['edit','updatechannelmsg']]);
         $this->middleware('permission:chats-delete', ['only' => ['destroy']]);
    }
