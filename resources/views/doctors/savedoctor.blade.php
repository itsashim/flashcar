               ...
               <div class="card-body">
                  ...
                  <div class="tab-content pl-3 p-1" id="myTabContent">
                     <div class="tab-pane fade <?= $tab_id == 1 ? 'show active' : "" ?> btnsaveoption" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <form action="{{url('doctor/updatedoctorprofile')}}" method="post"  enctype="multipart/form-data">
                           {{csrf_field()}}
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <input type="password" id="password" placeholder="{{__('messages.Enter').' '.__('messages.Password')}}" class="form-control" required name="password" value="{{ isset($data->password)?$data->password:''}}">
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-6">
                     ...
                     <div class="tab-pane fade <?= $tab_id == 2 ? 'show active' : "" ?> btnsaveoption" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <form action="{{url('doctor/updateworkinghours')}}" method="post"  enctype="multipart/form-data">
                           {{csrf_field()}}
                           <input type="hidden" name="id" id="id" value="{{$doctor_id}}"/>
                           ...
                           <table class="table table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><input type="time" required name="from[]" id="from{{$i}}" class="form-control" value="<?= isset($work->from) ? $work->from : "" ?>" placeholder="8:00" /></td>
                                    <td><input type="time" required name="to[]" id="to{{$i}}" value="<?= isset($work->to) ? $work->to : "" ?>" class="form-control" placeholder="23:00" onchange="checktime(this.value,'{{$i}}')" /></td>
                                    <td><input type="number" required name="token[]" id="token{{$i}}" value="<?= isset($work->token) ? $work->token : "" ?>" class="form-control" placeholder="23:00" onchange="checktime(this.value,'{{$i}}')" /></td>
                                 </tr>
                                 <?php $i++; ?>
                                 @endforeach  
                                 @else
                                 ...
                                 <tr>
                                    ...
                                    <td><input type="time" required name="from[]" id="from{{$i}}" class="form-control" value="{{time()}}" placeholder="8:00" /></td>
                                    <td><input type="time" required name="to[]" id="to{{$i}}" value="" class="form-control" onchange="checktime(this.value,'{{$i}}')" placeholder="23:00" /></td>
                                 </tr>
                                 <?php $i++; ?>
                                 @endforeach 
                                 @endif
