      ...
      <div class="page-header float-right">
         <div class="page-title">
            <ol class="breadcrumb text-right">
               <li class="active">{{__('Bike Brand')}}</li>
            </ol>
         </div>
      </div>
   </div>
         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                  ...
                  @endif
                  <div>
                     <a href="{{url('admin/bike-brand/create')}}" class="btn btn-primary">{{__('messages.Add').' Brand'}}</a>
                  </div>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="btn-group" role="group">
                                 <a href="{{route('bikebrand.edit',[$d->id]) }}" class="btn btn-primary">
                                    <i class="fa fa-edit"></i>
                                 </a>
                                 
                                    <a data-url="{{  route('bikebrand.destroy',[$d->id])  }}" data-id="{{  $d->id  }}" class="btn btn-danger rowDelete">
