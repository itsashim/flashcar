                    ...
                    <table id="service" class="table  table-striped table-bordered">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <a href="{{route('applied-seller.show',[$d->id]) }}" class="btn btn-success">
                                 <i class="fa fa-eye"></i>
                              </a>
                              <button class="btn btn-primary rowDelete" data-id="{{ $d->id }}" data-url="{{ route('seller.destroy',$d->id) }}" data-bs-toggle="modal" data-bs-target="#deleteCityModal"><i class="fa fa-trash"></i></button>
                           </td>
                        </tr>
                        @endforeach
                        @endif
