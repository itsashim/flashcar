         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                  ...
                  @endif
                  <div>
                     <a href="{{url('admin/clinic/create')}}" class="btn btn-primary">{{__('messages.Add').' Clinic'}}</a>
                  </div>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="btn-group" role="group">
                                 <a href="{{route('hospital.edit',[$d->id]) }}" class="btn btn-primary">
                                    <i class="fa fa-edit"></i>
                                 </a>
                                 <a data-url="{{  route('hospital.destroy',[$d->id])  }}" data-id="{{  $d->id  }}" class="btn btn-danger rowDelete">
