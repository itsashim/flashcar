        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('admin/hospital-appointment') }}" method="GET">
                                <div class="form-group col-md-12 paddiv">
                                    ...
                                    <div class="col-md-4 appbtn">
                                        ...
                                        <button type="button" name="reset" onclick="Resetappointment()"
                                            class="btn btn-primary">{{ __('messages.Reset') }}</button>
                                    </div>
                                </div>
                            </form>
                            <div class="table-responsive">
                                <table id="service" class="table table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>{{ __('messages.Token Number') }}</th>
                                            <th>Category</th>
                                            ...
                                            @foreach ($appointments as $d)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($d->status == 3)
                                                            <a href="#" data-app_id="{{ $d->id }}"
                                                                data-status="{{ $d->status }}"
                                                                class="btn btn-primary appointment_status">{{ __('messages.Approve') }}</a>
                                                        @elseif($d->status == 6)
                                                            <a href="#" data-app_id="{{ $d->id }}"
                                                                data-status="{{ $d->status }}"
                                                                class="btn btn-primary appointment_status">{{ __('messages.Reject') }}</a>
                                                        @elseif($d->status == 0)
                                                            <a href="#" data-app_id="{{ $d->id }}"
                                                                data-status="{{ $d->status }}"
                                                                class="btn btn-primary appointment_status">{{ __('messages.Absent') }}</a>
                                                        @elseif($d->status == 1)
                                                            <a href="#" data-app_id="{{ $d->id }}"
                                                                data-status="{{ $d->status }}"
                                                                class="btn btn-primary appointment_status">{{ __('messages.Receive') }}</a>
                                                        @elseif($d->status == 2)
                                                            <a href="#" data-app_id="{{ $d->id }}"
                                                                data-status="{{ $d->status }}"
                                                                class="btn btn-primary appointment_status">{{ __('messages.Reschedule') }}</a>
                                                        @elseif($d->status == 4)
                                                            <a href="#" data-app_id="{{ $d->id }}"
                                                                data-status="{{ $d->status }}"
                                                                class="btn btn-primary appointment_status">{{ __('messages.Complete') }}</a>
                                                        @elseif($d->status == 5)
                                                            <a href="#" data-app_id="{{ $d->id }}"
                                                                data-status="{{ $d->status }}"
                                                                class="btn btn-primary appointment_status">{{ __('messages.Refer Doctor') }}</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
