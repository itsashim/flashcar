         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                  ...
                  @endif
                  <div>
                     <a href="{{url('admin/product/create')}}" class="btn btn-primary">{{__('messages.Add').' Product'}}</a>
                  </div>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="btn-group" role="button">
                                    ...
                                    <a data-url="{{  route('product.destroy',[$d->id])  }}" data-id="{{  $d->id  }}" class="btn btn-danger rowDelete">
