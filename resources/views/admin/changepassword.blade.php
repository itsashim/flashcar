            ...
            <div class="card-body">
               <div id="pay-invoice">
                  <div class="card-body">
                     ...
                     @elseif(Session::get("err_message"))
                     ...
                     <form action="{{url('admin/updatepassword')}}" method="post"   enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <input type="password" id="cpwd" placeholder="{{__('messages.Enter Current Password')}}" class="form-control" name="cpwd"   >{{-- onchange="checkcurrentpwdtest(this.value)" --}}
                            @error('cpwd')
                        ...
                        <div class="form-group">
                           ...
                           <input type="password" id="npwd" placeholder="{{__('messages.Enter New Password')}}" class="form-control" name="npwd"  >
                            @error('npwd')
                               <span class="text-danger bg-secondary">
                                   {{ $message }}
                               </span>
                        ...
                        <div class="form-group">
                           ...
                           <input type="password" id="rpwd" placeholder="{{__('messages.Re-enter New Password')}}" class="form-control" name="rpwd" onchange="changecheckboth(this.value)" >
                        </div>
                         @error('rpwd')
                               <span class="text-danger bg-secondary">
                                   {{ $message }}
