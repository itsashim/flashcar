         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                  ...
                  @endif
                  <div>
                     <a href="{{url('admin/customer/create')}}" class="btn btn-primary">{{__('messages.Add').' Customer'}}</a>
                  </div>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="btn-group" role="button">
                                 <a href="{{route('customer.show',[$d->id]) }}" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                 <a href="{{route('customer.edit',[$d->id]) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                 <a data-url="{{  route('customer.destroy',[$d->id])  }}" data-id="{{  $d->id  }}" class="btn btn-danger rowDelete"><i class="fa fa-trash"></i></a>
                              </div>
                           </td>
                        </tr>
                        @endforeach
