                    ...
                    <table id="service" class="table  table-striped table-bordered">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{$d->name}}</td>
                           <td>
                              <a href="{{route('city.edit',[$d->id]) }}" class="btn btn-primary">{{__('messages.Edit')}}</a>
                              <a data-url="{{  route('city.destroy',[$d->id])  }}" data-id="{{  $d->id  }}" class="btn btn-danger rowDelete">{{__('messages.Delete')}}</a>
                           </td>
                        </tr>
                        @endforeach
                        @endif
