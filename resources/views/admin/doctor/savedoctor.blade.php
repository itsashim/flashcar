      ...
      <div class="page-header float-right">
         <div class="page-title">
            <ol class="breadcrumb text-right">
               <li><a href="{{url('admin/doctor')}}">Car</a></li>
                        ...
                        <form action="{{route('services.store')}}" method="post"  enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <input type="text" id="name" placeholder="Enter Car Name" class="form-control" required name="name" value="{{ isset($data->name)?$data->name:''}}" >
                              </div>
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <input type="text" id="daily_fee" placeholder="{{__('messages.Enter').' '.__('Daily Fee')}}" class="form-control" required name="daily_fee" value="{{ isset($data->daily_fee)?$data->daily_fee:''}}" >
                              </div>
                              <div class="col-md-4">
                                 ...
                                 <input type="text" id="weekly_fee" placeholder="{{__('messages.Enter').' '.__('Weekly Fee')}}" class="form-control" required name="weekly_fee" value="{{ isset($data->weekly_fee)?$data->weekly_fee:''}}" >
                              </div>
                              <div class="col-md-4">
                                 <label for="phone" class=" form-control-label">
                                 ...
                                 <input type="text" id="monthly_fee" placeholder="{{__('messages.Enter').' '.__('Monthky Fee')}}" class="form-control" required name="monthly_fee" value="{{ isset($data->monthly_fee)?$data->monthly_fee:''}}" >
                              </div>
                           </div>
                           ...
                           <div class="form-group">
                              <h3 class="mb-4 text-center">Specs</h3>
                               <div class="col-md-4">
                                 ...
                                 <input type="text" id="power" placeholder="{{__('messages.Enter').' '.__('Power')}}" class="form-control" required name="power" value="{{ isset($data->power)?$data->power:''}}" >
                              </div>
                              <div class="col-md-4">
                                 ...
                                 <input type="text" id="max_speed" placeholder="{{__('messages.Enter').' '.__('Max Speed')}}" class="form-control" required name="max_speed" value="{{ isset($data->max_speed)?$data->max_speed:''}}" >
                              </div>
                              <div class="col-md-4">
                                 ...
                                 <input type="text" id="acceleration" placeholder="{{__('messages.Enter').' '.__('Acceleration')}}" class="form-control" required name="acceleration" value="{{ isset($data->acceleration)?$data->acceleration:''}}" >
                              </div>
                           ...
                           <div class="form-group">
                               <div class="col-md-4">
                                 ...
                                 <input type="text" id="door" placeholder="{{__('messages.Enter').' '.__('Door')}}" class="form-control" required name="door" value="{{ isset($data->door)?$data->door:''}}" >
                              </div>
                              <div class="col-md-4">
                                 ...
                                 <input type="text" id="seat" placeholder="{{__('messages.Enter').' '.__('Seat')}}" class="form-control" required name="seat" value="{{ isset($data->seat)?$data->seat:''}}" >
                              </div>
                              <div class="col-md-4">
                                 <label for="phone" class=" form-control-label">
                                 {{__('Luggage')}}
                                 ...
                                 <input type="text" id="luggage" placeholder="{{__('messages.Enter').' '.__('Luggage')}}" class="form-control" required name="luggage" value="{{ isset($data->luggage)?$data->luggage:''}}" >
                              </div>
                           ...
                           <div class="form-group">
                               <div class="col-md-4">
                                 ...
                                 <input type="text" id="transmission" placeholder="{{__('messages.Enter').' '.__('Transmission')}}" class="form-control" required name="transmission" value="{{ isset($data->transmission)?$data->transmission:''}}" >
                              </div>
                              <div class="col-md-4">
                                 ...
                                 <input type="text" id="ac" placeholder="{{__('messages.Enter').' '.__('Ac')}}" class="form-control" required name="ac" value="{{ isset($data->ac)?$data->ac:''}}" >
                              </div>
                              <div class="col-md-4">
                                 ...
                                 <input type="text" id="car_years" placeholder="{{__('messages.Enter').' '.__('Car Years')}}" class="form-control" required name="car_years" value="{{ isset($data->car_years)?$data->car_years:''}}" >
                              </div>
