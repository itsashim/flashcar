                        ...
                        <tr>
                           ...
                           <td>
                              <div class="btn-group" role="button">
                                 <a href="{{url('admin/savedepartment/').'/'.$d->id}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
   
                                 <a href="javascript:deleterow('deletedepartment','<?= $d->id ?>')" class="btn btn-sm btn-danger"><i class="fa fa-trash text-white"></i></a>
   
                                {{--  <a href="{{url('admin/departmentservice/').'/'.$d->id}}"  class="btn btn-sm btn-warning btndepartwarning"><i class="fa fa-plus"></i> Add Services</a> --}}
                              </div>
