 ...
 .bg-text1{
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="{{ asset('public/images/background1.jpg') }}" alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="{{ asset('public/images/background3.jpg') }}" alt="Second slide">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="{{ asset('public/images/background1.jpg') }}" alt="Third slide">
      <div class="carousel-caption d-none d-md-block">
    <h5 class="bg-text">this is a section text</h5>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <!--                <img src="{{ asset('public/images/background1.jpg') }}" class="d-block w-100" alt="..."-->
        <!--                    style=" object-fit:cover  " ></img>-->
                            
        <!--            </div>-->
                     
        <!--            <div class="carousel-item" style="">-->
        <!--                <img src="{{ asset('public/images/background3.jpg') }}" class="d-block w-100" alt="..."-->
        <!--                    style=" object-fit:cover"></img>-->
        ...
        {{--
        <!--<div class="container">-->
        <!--    <div class="header-appo-main-box" data-aos="zoom-in" style="margin-top: 190px;margin-bottom:100px;width:60%;border-radius:60px;opacity:0.99; padding:0 !important;">-->
        <!--        <div data-aos="zoom-in">-->
                   
        <!--            <form class="input-group" action="{{ asset('site-search') }}" method="GET">-->
        <!--            <input name="search" type="search" class="form-control rounded-0"-->
        <!--                placeholder="Search for hospitals, doctors, medicines etc..." aria-label="Search"-->
        <!--                aria-describedby="search-addon" />-->
        <!--                 <div class="input-group-append">-->
        <!--                  <button type="submit" class="btn btn-success font-weight-bold rounded-0"><i class="fa-solid fa-magnifying-glass text-light"></i>Search</button>-->
        <!--                  </div>-->
        ...
        <!--            <div class="sufee-alert alert with-close alert-success alert-dismissible fade show" data-aos="zoom-in">-->
        <!--                {{ Session::get('message') }}-->
        ...
        <!--            {{ csrf_field() }}-->
        <!--            <div class="appo-select-main-box" data-aos="zoom-in">-->
        <!--                <div class="appo-select-box" data-aos="zoom-in">-->
        ...
        <!--            </div>-->
        <!--            <div class="appo-input-main-box" data-aos="zoom-in">-->
        ...
        <!--            </div>-->
        <!--            <div class="appo-btn-main-box" data-aos="zoom-in">-->
        <!--                @if (Auth::id())-->
    ...
    {{-- <div class="services-main-box">
        <div class="container">
            <div class="services-left-part" data-aos="zoom-in">
                <div class="left-part-detail" data-aos="zoom-in">
                    <h2>{{ __('messages.Personal care & healthy living') }}</h2>
                    <p>{{ __('messages.facilitydetails') }}</p>
                    <div class="services-btn-main-box" data-aos="zoom-in">
                    ...
                    @if (count($services) > 0)
                        ...
                        @foreach ($services as $s)
                            <div class="col-md-4 col-sm-6" data-aos="zoom-in">
                                @if ($i % 2 == 0)
                                    <div class="services-part-box services-part1-box" data-aos="zoom-in">
                                    @else
                                        <div class="services-part-box services-part2-box" data-aos="zoom-in">
                                @endif
                                <img src="{{ asset('public/upload/service') . '/' . $s->icon }}">
                                <div class="text-detail-box" data-aos="zoom-in">
                                    <h4>{{ $s->name }}</h4>
                                    <p>{{ $s->description }}</p>
                                </div>
                            </div>
        ...
        <div class="container" style="padding-top: 80px;">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 text-right pt-2" data-aos="zoom-in">
                    <a href="{{ asset('hospitals') }}" style="    padding: 7px 10px; border: 2px solid #c7c7c7;">View All Hospital &nbsp;
            ...
            <div class="owl-carousel loop5 pb-5 pt-4" data-aos="zoom-in">
                ...
                <div class="item" data-aos="zoom-in">
                    <div class="card" data-aos="zoom-in" style="width: 23rem;box-shadow: none; border:0px">
                        ...
                        @else
                        <img class="card-img-top" src="{{ asset('public/images/hospital.png') }}" alt="Card image cap" style="    height: 215px;">
                        @endif
                        </a>
                        <div class="card-body" data-aos="zoom-in" style="padding: 10px">
                            ...
                            <p class="card-text pb-2">{{ isset($hospital->city->name)?$hospital->city->name:"-" }} </p>
    ...
    <section>
        <div class="container" style="padding-top: 80px;">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 text-right pt-2" data-aos="zoom-in">
                    <a href="{{ asset('doctors') }}" style="    padding: 7px 10px; border: 2px solid #c7c7c7;">View All Doctor &nbsp;<i
            ...
            <div class="owl-carousel loop2 pb-5 pt-4">
                ...
                <div class="item" data-aos="zoom-in">
                    <div class="card" data-aos="zoom-in" style="width: 17rem;box-shadow: none; border:0px">
                        ...
                        @else
                            <img class="card-img-top"  src="{{ asset('public/images/doctor.png')}}"  alt="Card image cap">
                        @endif
                        <div class="card-body" data-aos="zoom-in" style="    border: 0px;     padding: 10px 4px 8px 0px;">
                            <h5>{{ $doctor->name }}</h5>
                            <p class="card-text pb-2">{{ $doctor->service }} </p>
                            <p>
                                <a href="{{ asset('find-doctor?doctor_id='.$doctor->id) }}" class="btn  btn-sm text-light"  role="button"  style="background: #00be9c !important;"> 
    ...
    <section>
        <div class="container" style="padding-top: 80px;">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 text-right pt-2" data-aos="zoom-in">
                    <a href="{{ asset('department') }}" style="    padding: 7px 10px; border: 2px solid #c7c7c7;">View All &nbsp;<i
                            class="fa fa-angle-right " aria-hidden="true"></i></a>
                </div>
            ...
            <div class="owl-carousel loop3  pt-4">
                ...
                --}}
                    ...
                    <div class="imagetop" data-aos="zoom-in">
                        <a href="{{'https://sansarhealth.com/find-doctor?department_id='.$department-> id}}">
                            <img style="margin:auto;" src="{{ asset('public/upload/department/'.$department->image) }}">
                        </a>
                    </div>
                    <div class="name" data-aos="zoom-in"> <a href="{{'https://sansarhealth.com/find-doctor?department_id='.$department-> id}}">{{ $department->name }}</a></div>
                    <div class="desc" data-aos="zoom-in">{{substr($department->description, 0, strpos($department->description, ' ',70))}} ...</div>
                        <!--<div class="desc"> {{ substr($department->description,0,70) }} ...</div>-->
                    </div>
                ...
                <div class="col-12 pb-4" data-aos="zoom-in">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 col-12" data-aos="zoom-in">
                            <div
                                style="background-image: url('{{ asset('public/front/ld.PNG') }}'); background-position: center center; background-size: cover;   background-repeat: no-repeat;" class="rounded" data-aos="zoom-in">
                                <div
                                    ...
                                    <div class="p-2" style="    border: 1px solid #d7d5d5;    height: 194px;">
                                        <div class="row">
                                            ...
                                            <div class="col-8 p-0" data-aos="zoom-in">
                                                <a href="{{ asset('categories/'.$category->slug) }}">
                                                    <p class="m-0" style="font-size:14px;"><b>{{ $category->name }}</b></p>
                                                </a>
                                                @foreach($category->subCategory->take(5) as $subCategory)
                                                <a href="{{ asset('sub-categories/'.$subCategory->slug) }}">
                                                    <p class="m-0" style="font-size:12px;">{{ $subCategory->name }}</p>
                                                </a>
                                                @endforeach
                                            </div>
                                        </div>
    ...
    <div class="pricing-main-box flex">
        ...
        <div class="container ">
             <div class="row">
                ...
                <div class="col-lg-6 col-12 text-right pt-2" data-aos="zoom-in">
                    <a href="{{ asset('pricing') }}" style="    padding: 7px 10px; border: 2px solid #c7c7c7;">View All Package &nbsp;
                        <i class="fa fa-angle-right " aria-hidden="true" ></i>
                    </a>
                </div>
             </div>
    ...
    <div class="container my-5  ">
        <div class="row">
                ...
                <div class="col-lg-6 col-12 text-right pt-2" data-aos="zoom-in">
                    <a href="{{ asset('hospitals') }}" style="    padding: 7px 10px; border: 2px solid #c7c7c7;">View All Blog &nbsp;
                        <i class="fa fa-angle-right " aria-hidden="true" ></i>
                    </a>
                </div>
            </div>
...
<style>
                    ...
                    <center>
                        <div class="card" data-aos="zoom-in" style="width: 18rem;">
                            ...
                            <div class="card-body" data-aos="zoom-in">
                                ...
                                <p><button href="{{ asset('blogs/'.$blog->slug) }}" class="btn btn-primary">Read More <i class="fa fa-hand-o-left " aria-hidden="true"></i></button>
                                </p>
                            </div>
                        </div>
                    </center>
    ...
    {{-- <div class="testimonial-main-box">
        <div class="container">
            ...
            <div class="testimonial-part-main-box" data-aos="zoom-in">
                <div class="owl-carousel testimonial-carousel" data-aos="zoom-in">
                    @if ($review)
                        @foreach ($review as $r)
                            <div class="single-testimonial" data-aos="zoom-in">
                                <div class="testimonial-part-box" data-aos="zoom-in">
                                    <div class="testimonial-inner-images" data-aos="zoom-in">
                                        <div class="col-md-3 testimage" data-aos="zoom-in">
                                            <?php
                                        ...
                                        <div class="col-md-9 testtext" data-aos="zoom-in">
    ...
    <div id="modalHealthPartner" class="modal fade bd-example-modal-lg" style="margin-top: 70px;" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" data-aos="zoom-in">
          <div class="modal-content" data-aos="zoom-in">
            ...
            @endif
            <form id="appliedHealthForm" action="{{ asset('applied-health-partner') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row hide" id="alertSectionAHP">
                    <div class="col-sm-12">
                        <div class="alert" id="alertMsgAHP">
                             <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                ...
                <div class="modal-body" id="bodySectionAHP" data-aos="zoom-in" style="background-color:#f1f1f9">
                    ...
                    <button type="button" class="btn btn-danger mt-3 float-right" data-bs-dismiss="modal">
                        Close
                    </button>
                </div>
    ...
    <div id="modalDoctor" class="modal fade bd-example-modal-lg" style="margin-top: 70px;" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          ...
          <div class="modal-content">
            ...
            @endif
            <form id="appliedDoctorForm" action="{{ asset('applied-doctor') }}" method="POST" enctype="multipart/form-data">
