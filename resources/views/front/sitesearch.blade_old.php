...
@endif
                         ...
                         {{-- <span>{{ (isset($doctor->hospital))?$doctor->hospital->name: $doctor->hospital->id }}</span> --}}
                         <span>{{ isset($doctor->hospital) ? $doctor->hospital->name : '-' }}</span>
                        <div class="share ">
                                            <a class="btn bg-lightgreen text-light text-capitalize" href="{{ asset('find-doctor?doctor_id=' . $doctor->id) }}">Book appointment</a>
                                        </div>
                                    </div>
     @endforeach
                        </div>
