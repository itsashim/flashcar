...
<style>
        /*Related Blog */
            ...
            .blog_blog:hover{
              cursor: pointer;
             background-image: linear-gradient(45deg,  rgba(0, 0, 0, 0.264) 70%,  rgba(255, 255, 255, 0.296)) , url('{{asset('public/'.$blog->image)}}');
...
{!! $blog->description !!}
              ...
              <div class="d-flex align-items-center">
                <a class="text-decoration-none text-dark" href="#"
                  ><i class="fa-regular fa-clock h6">   {{ \Carbon\Carbon::parse($blog->created_at)->format('Y-m-d h:m:s') }}</i>
                </a>
