...
@section('content')
    ...
    <div class="banner">
        ...
        <div class="content">
            ...
            <a class="button" href="{{ url('bluebook-tax-rates') }}">View Tax Fares</a>
        ...
        <div class="image-container">
            ...
            <img src="{{ url('public/images/cover-image.jpg') }}" alt="Image Description" />
    ...
    <div class="container-fluid p-5">
        ...
        <form action="{{ route('bluebook') }}" method="POST" enctype="multipart/form-data" oninput="calculatePrice()">
