...
@section('styles')
    ...
    <link rel="alternate" type="application/rss+xml" title="My Blog &raquo; Feed" href="{{ asset('public/doctorpage') }}" />
    ...
    <link rel='stylesheet' id='wp-block-library-css'
        href='{{ asset('public/doctorpage') }}/css/dist-block-library-style.min.css' media='all' />
    ...
    <link rel='stylesheet' id='ivory-search-styles-css'
        href='{{ asset('public/doctorpage') }}/css/add-search-to-menu-public-css-ivory-search.min.css' media='all' />
    <link rel='stylesheet' id='57dbb5e0c-css'
        href='{{ asset('public/doctorpage') }}/css/essential-addons-elementor-734e5f942.min.css' media='all' />
    <link rel='stylesheet' id='font-awesome-css'
        href='{{ asset('public/doctorpage') }}/css/oceanwp-assets-fonts-fontawesome-css-all.min.css' media='all' />
    <link rel='stylesheet' id='simple-line-icons-css'
        href='{{ asset('public/doctorpage') }}/css/oceanwp-assets-css-third-simple-line-icons.min.css' media='all' />
    <link rel='stylesheet' id='oceanwp-style-css'
        href='{{ asset('public/doctorpage') }}/css/oceanwp-assets-css-style.min.css' media='all' />
    <link rel='stylesheet' id='elementor-icons-css'
        href='{{ asset('public/doctorpage') }}/css/elementor-assets-lib-eicons-css-elementor-icons.min.css'
        media='all' />
    ...
    <link rel='stylesheet' id='elementor-frontend-css'
        href='{{ asset('public/doctorpage') }}/css/elementor-assets-css-frontend-lite.min.css' media='all' />
    <link rel='stylesheet' id='elementor-post-5-css' href='{{ asset('public/doctorpage') }}/css/elementor-css-post-5.css'
        media='all' />
    <link rel='stylesheet' id='elementor-global-css' href='{{ asset('public/doctorpage') }}/css/elementor-css-global.css'
        media='all' />
    <link rel='stylesheet' id='elementor-post-432-css'
        href='{{ asset('public/doctorpage') }}/css/elementor-css-post-432.css' media='all' />
    <link rel='stylesheet' id='oe-widgets-style-css'
        href='{{ asset('public/doctorpage') }}/css/ocean-extra-assets-css-widgets.css' media='all' />
    ...
    <link rel='stylesheet' id='elementor-icons-shared-0-css'
        href='{{ asset('public/doctorpage') }}/css/elementor-assets-lib-font-awesome-css-fontawesome.min.css'
        media='all' />
...
{{--
                    <div class="col-sm-3">
                        <select class="float-right form-control" id="cityID">
                            <option value="null">Select City</option>
                            @foreach ($cities as $city)
                                <option @if (request()->city_id == $city->id) selected="selected" @endif
                                    ...
                                    <div class="col-md-5 flex-fill">
                                        <div class="p-3 pb-0 d-xl-flex mb-3 docdetail2029">
                                            <div class="text-center">
                                                <a href="javascript:void(0);" data-docid="{{ $doctor->id }}"
                                                    data-orgid="614" data-nextavltime="Aug 25 at 7:00 PM"
                                                    class="d-block doctorprofile">
                                                    
                                                    @if($doctor->image)
                                                        <img class="rounded-circle border-success" src="{{ asset('public/upload/doctor/'.$doctor->image) }}" title=" {{ $doctor->image }}" style="width: 200px; height:200px;">
                                                    @else
                                                        <img class="rounded-circle border-success" src="{{ asset('public/images/doctor.png')}}" title=" {{ $doctor->image }}" style="width: 200px; height:200px;">
                                                    @endif
                                                ...
                                                <div class="d-xl-none">
                                                    <h6 class="my-2" data-depid="1974"
                                                        data-docid="{{ $doctor->id }}" data-gdepid="14"
                                                        data-gdocid="623" data-orgid="614" id="doctordetail">
                                                        {{ $doctor->name }} </h6>
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <div class="d-none d-xl-block pb-2">
                                                    <h5 class="mb-3" data-depid="1974" data-docid="2696"
                                                        ...
                                                        id="doctordetail"> {{ $doctor->name }} </h5>
...
{{--
                                                        <p class="mb-2 pb-1"><i
                                                                class="bi bi-caret-right-square-fill me-1 text-success"></i>Next
                                                            Available Time:
                                                            <span class="text-primary pt-1">Aug 25 at 7:00 PM </span>
                                                        </p>
--}}
                                                    </div>
                                                        ...
                                                        <tbody class="small align-middle">
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    ?>
                                                                    <div class="m-1">
                                                                        {{ \Carbon\Carbon::now()->format('Y/m/d') }} <span class="badge badge-warning text-light">Today</span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="m-1">
                                                                        ...
                                                                        @if($todayToken > 0)
                                                                            @for ($i = 0; $i < $todayToken; $i++)
                                                                                @if ($i == 0)
                                                                                        ...
                                                                                        @endif
                                                                                @else
                                                                                        @if( ($todayTimeTable->to > \Carbon\Carbon::parse($todayTimeTable->from)->addMinutes($tokenTime + 60)->format('H:i')) )
                                                                                            @if( \Carbon\Carbon::now()->format('H:i') <= \Carbon\Carbon::parse($todayTimeTable->from)->addMinutes($tokenTime + 60)->format('H:i'))
                                                                                           ...
                                                                                           <?php
                                                                                            ...
                                                                                            ?>
                                                                                                ...
                                                                                                @else
                                                                                                    <span class="btn btn-danger" title="doctor taken" style="cursor: not-allowed;">{{ $time }}</span>    
                                                                                                    <?php $tokenTime = $tokenTime + 60; ?>
                                                                                                @endif
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="m-1">
                                                                        {{ \Carbon\Carbon::now()->addDays(1)->format('Y/m/d') }} <span class="badge badge-warning text-light">Tomorrow</span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="m-1">
                                                                 @if($tommorowTimeTable->status != '0')
                                                                        @if (isset($tommorowTimeTable->from) && isset($tommorowTimeTable->to))
                                                                            {{ $tommorowTimeTable->from }} -
                                                                            ...
                                                                            @for ($i = 0; $i < $tommorrowToken; $i++)
                                                                                @if ($i == 0)
                                                                                    ...
                                                                                    ?>
                                                                                        ...
                                                                                        @else
                                                                                            <a class="btn btn-danger" style="cursor: not-allowed;">{{ $tommorowTimeTable->from }}</a>
                                                                                        @endif
                                                                                                
                                                                                                
                                                                                    @endif    
                                                                                @else
                                                                                    @if ( $tommorowTimeTable->to > \Carbon\Carbon::parse($tommorowTimeTable->from)->addMinutes($tokenTime + 60)->format('H:i'))
                                                                                    ...
                                                                                    @if($else_app3 == 0)
                                                                                        <a class="btn bookThisTime "
                                                                                            ...
                                                                                            data-id="{{ $doctor->id }}"
                                                                                            data-date="{{ \Carbon\Carbon::now()->addDays(1)->format('Y-m-d') }}"
                                                                                            data-time="{{ \Carbon\Carbon::parse($tommorowTimeTable->from)->addMinutes($tokenTime + 60)->format('H:i') }}"
                                                                                            style="background: #00be9c;"
                                                                                            >{{ \Carbon\Carbon::parse($tommorowTimeTable->from)->addMinutes($tokenTime + 60)->format('H:i') }}</a> {{-- style="background: #00be9c;" --}}
                                                                                        <?php $tokenTime = $tokenTime + 60; ?>
                                                                                    @else
                                                                                         <a class="btn btn-danger" style="cursor: not-allowed;">{{ \Carbon\Carbon::parse($tommorowTimeTable->from)->addMinutes($tokenTime + 60)->format('H:i') }}</a>
                                                                                         <?php $tokenTime = $tokenTime + 60; ?>
                                                                                    @endif
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="m-1">
                                                                        {{ \Carbon\Carbon::now()->addDays(2)->format('Y/m/d') }} <span class="badge badge-warning text-light">Day After Tomorrow</span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="m-1">
                                                                     @if($dayAfterTommorowTimeTable->status != '0')
                                                                ...
                                                                <td>
                                                                @if($dayAfterTommorowTimeTable->status != '0')
                                                                    @if($dayAfterTommorowTimeTable->token > 0)
                                                                        @if (isset($dayAfterTommorowTimeTable->from) && isset($dayAfterTommorowTimeTable->to))
                                                                        <div class="m-1">
                                                                            <?php
                                                                            ...
                                                                            @for ($i = 0; $i < $dayAfterTommorrowToken; $i++)
                                                                                @if ($i == 0)
                                                                                        ...
                                                                                        ?>
                                                                                            ...
                                                                                            @else
                                                                                                <a class="btn btn-danger" style="cursor:not-allowed"> {{ $dayAfterTommorowTimeTable->from }}</a>
                                                                                            @endif
                                                                                            
                                                                                        @endif
                                                                                @else
                                                                                    @if ( $dayAfterTommorowTimeTable->to > \Carbon\Carbon::parse($dayAfterTommorowTimeTable->from)->addMinutes($tokenTime + 60)->format('H:i'))
                                                                                        ...
                                                                                        @if($else_app5 == 0)
                                                                                            <a class="btn bookThisTime"
                                                                                                ...
                                                                                                data-id="{{ $doctor->id }}"
                                                                                                data-date="{{ \Carbon\Carbon::now()->addDays(2)->format('Y-m-d') }}"
                                                                                                data-time="{{ \Carbon\Carbon::parse($dayAfterTommorowTimeTable->from)->addMinutes($tokenTime + 60)->format('H:i') }}"
                                                                                                style="background: #00be9c;">
                                                                                                {{ \Carbon\Carbon::parse($dayAfterTommorowTimeTable->from)->addMinutes($tokenTime + 60)->format('H:i') }}
                                                                                            </a>
                                                                                            <?php $tokenTime = $tokenTime + 60; ?>
                                                                                        @else
                                                                                            <a class="btn btn-danger" style="cursor:not-allowed">{{ \Carbon\Carbon::parse($dayAfterTommorowTimeTable->from)->addMinutes($tokenTime + 60)->format('H:i') }}</a>
                                                                                            <?php $tokenTime = $tokenTime + 60; ?>
                                                                                        @endif
...
@section('scripts')
    ...
    <script src='{{ asset('public/doctorpage') }}/js/essential-addons-elementor-734e5f942.min.js' id='57dbb5e0c-js'>
    </script>
    ...
    <script src='{{ asset('public/doctorpage') }}/js/oceanwp-assets-js-drop-down-mobile-menu.min.js'
        id='oceanwp-drop-down-mobile-menu-js'></script>
    <script src='{{ asset('public/doctorpage') }}/js/oceanwp-assets-js-drop-down-search.min.js'
        id='oceanwp-drop-down-search-js'></script>
    <script src='{{ asset('public/doctorpage') }}/js/oceanwp-assets-js-vendors-magnific-popup.min.js'
        id='ow-magnific-popup-js'></script>
    <script src='{{ asset('public/doctorpage') }}/js/oceanwp-assets-js-ow-lightbox.min.js' id='oceanwp-lightbox-js'>
    </script>
    <script src='{{ asset('public/doctorpage') }}/js/oceanwp-assets-js-vendors-flickity.pkgd.min.js' id='ow-flickity-js'>
    </script>
    <script src='{{ asset('public/doctorpage') }}/js/oceanwp-assets-js-ow-slider.min.js' id='oceanwp-slider-js'></script>
    <script src='{{ asset('public/doctorpage') }}/js/oceanwp-assets-js-scroll-effect.min.js' id='oceanwp-scroll-effect-js'>
    </script>
    <script src='{{ asset('public/doctorpage') }}/js/oceanwp-assets-js-scroll-top.min.js' id='oceanwp-scroll-top-js'>
    </script>
    ...
    <script src='{{ asset('public/doctorpage') }}/js/add-search-to-menu-public-js-ivory-search.min.js'
    ...
    <script src='{{ asset('public/doctorpage') }}/js/elementor-assets-js-webpack.runtime.min.js'
        id='elementor-webpack-runtime-js'></script>
    <script src='{{ asset('public/doctorpage') }}/js/elementor-assets-js-frontend-modules.min.js'
        id='elementor-frontend-modules-js'></script>
    <script src='{{ asset('public/doctorpage') }}/js/elementor-assets-lib-waypoints-waypoints.min.js'
    ...
    <script src='{{ asset('public/doctorpage') }}/js/elementor-assets-js-frontend.min.js' id='elementor-frontend-js'>
    </script>
    <script>
        $(function() {
