      ...
      <a href="<?php echo e(url('admin/product')); ?>">
         <div class="card-body">
            <div class="stat-widget-one" >
               ...
               <div class="stat-content dib">
                  <div class="stat-text"><?php echo e(__('messages.Total')); ?></div>
                  <div class="stat-text"><?php echo e(__('Categories')); ?>
   ...
   <div class="row">
      ...
      <div class="col-md-12 col-xl-6 col-12 flat-r">
         <div class="card">
            <div class="card-body">
               <h4 class="orderh4">
                  <i class="fa fa-calendar mr-2" aria-hidden="true"></i><?php echo e(__('messages.Latest').' '.__('messages.Appointment')); ?> 
      ...
      <div class="col-md-12 col-xl-6 col-12 flat-r">
         <div class="card">
            <div class="card-body">
               <h4 class="orderh4">
                  <i class="fa fa-comments-o mr-2" aria-hidden="true"></i><?php echo e(__('messages.Latest').' '.__('messages.Review')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shahbazali.website/rental.shahbazali.website/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>