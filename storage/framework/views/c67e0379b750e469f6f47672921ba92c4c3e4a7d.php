               ...
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="<?php echo e(route('servicesProvider.approved')); ?>">Approved Fleet</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(route('servicesProvider.appointment')); ?>">Fleet Appointments</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(route('servicesProvider.pending')); ?>">Pending Fleet</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(route('servicesProvider.disabled')); ?>">Rejected Fleet</a></li>
                     </ul>
                  </li>
                  <?php endif; ?>
...
<?php /**PATH /home/flashcarsrental.com/public_html/resources/views/admin/layout.blade.php ENDPATH**/ ?>