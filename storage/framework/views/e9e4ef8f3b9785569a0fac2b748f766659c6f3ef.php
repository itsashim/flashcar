...
<?php $__env->startSection('content'); ?>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-item active">
            <img class="d-block w-100 carousel-image" src="<?php echo e(asset('public/front/frontPageImg1.jpeg')); ?>" alt="First slide">
            
        </div>
        <div class="carousel-item">
            <img class="d-block w-100 carousel-image" src="<?php echo e(asset('public/front/frontPageImg1.jpeg')); ?>" alt="Second slide">
          
        </div>
        <div class="carousel-item">
            <img class="d-block w-100 carousel-image" src="<?php echo e(asset('public/front/frontPageImg1.jpeg')); ?>" alt="Third slide">
    ...
    <!--                <div class="inner-box" style="padding: 10px 20px 15px 20px;background: #019444;">-->
    <!--                    <div class="row">-->
    <!--                        <div class="col-2">-->
    <!--                            <div class="icon">-->
    ...
    <!--            </div>-->
    <!--            <div class="col-lg-3 col-md-6 mt-2">-->
    <!--                <div class="inner-box" style="padding: 10px 20px 10px 20px;background: #019444;">-->
    ...
    <!--                            <span class="btn form-control" style="background-color: #019444; color:#fff;border: 2px solid #fff">Emergency Service</span>-->
    <!--                        </a>-->
    <!--                    </div>-->
    <!--                </div>-->
    <!--            </div>                  -->
...
<!-- Category Section -->
    ...
    <section class="categories_sec container">
      <div class="categories_wrapper pb-0">
        <div class="row mb-3">
                <div class="col-lg-8 col-md-8 aos-init aos-animate" data-aos="zoom-in" style="    border-left: 7px solid #019444;">
                ...
                <div class="col-lg-4 col-md-4 text-lg-right pb-sm-20 pt-3 aos-init aos-animate viewAllDesktop" data-aos="zoom-in">
                    <a href="<?php echo e(asset('department')); ?>" class="ViewAllBtn">View All Categories &nbsp;
        ...
        >
          ...
          <div class="item">
            <div class="categories_img_div">
                <a href="<?php echo e('https://sathiservice.com/departmentlist?department_id='.$department-> id); ?>">
              <img
                class="categories_img"
                src="<?php echo e(asset('public/upload/department/'.$department->image)); ?>"
                alt="White air-conditioner"
              />
              </a>
            </div>
            <h4 class="categories_h4"><a href="<?php echo e('https://sathiservice.com/departmentlist?department_id='.$department-> id); ?>" style="color:#000"><?php echo e($department->name); ?></a></h4>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      </div>
                ...
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="item">
                        ...
                        <span class="img-text text-center">
                          ...
                          <p class="pb-2"><?php echo e($doctor->service); ?> </p> 
    ...
    <section class="hiw_sec">
      <div class="hiw_wrapper">
        ...
        <div class="process_div row">
          <div class="process step-one col-md-4">
            <div class="process_img_div">
              <img
                class="process_img"
                src="<?php echo e(asset('public/upload/selectPackage.png')); ?>"
                alt=""
              />
            </div>
          ...
          <div class="process step-two col-md-4">
            <div class="process_img_div">
              <img
                class="process_img"
                src="<?php echo e(asset('public/upload/chooseService.png')); ?>"
                alt=""
              />
            </div>
          ...
          <div class="process step-three col-md-4">
            <div class="process_img_div">
              <img
                class="process_img"
                src="<?php echo e(asset('public/upload/bookAppointment.png')); ?>"
                alt=""
              />
            </div>
      ...
      <div class="hire_wrapper">
        <div class="hire_left">
          <div class="hire_img_div">
            <img
              class="hire_img"
              src="<?php echo e(asset('public/upload/inidianMaind.png')); ?>"
              alt=""
            />
          </div>
        </div>
    ...
    <section class="medicine-seller-priscription">
        <div class="container" style="padding-top: 80px;padding-bottom: 20px">
            <div class="row">
                <div class="col-lg-6  aos-init aos-animate " data-aos="zoom-in" style="    border-left: 7px solid #019444;">
                <!--<div class="col-lg-6 col-12 aos-init aos-animate " data-aos="zoom-in" style="    border-left: 7px solid #019444;">-->
            ...
            <div class="row pt-5 pb-5  ">
                <div class="col-lg-6 col-sm-12 seller aos-init aos-animate" data-aos="zoom-in">
                    <div class="p-3" style="background:#019444;border-radius:10px;">
                ...
                <div class="col-lg-6 col-sm-12 seller aos-init aos-animate" data-aos="<?php echo e(url('resources/views/seller.jpg')); ?>zoom-in">
 ...
 <!-- download in mobile -->
    <section class="download_app_sec">
      <div class="download_app">
        <div class="dom_img_div" >
          <img
             style="width: 100%;transform: rotate(20deg);border-radius:35px"
            class="dom_img"
            src="<?php echo e(asset('public/upload/MobileSS.jpg')); ?>"
            alt=""
          />
        </div>
        ...
        <div class="container ">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 text-lg-right pt-2 aos-init aos-animate viewAllDesktop" data-aos="zoom-in" >
                    <a href="https://sathiservice.com/pricing" class="ViewAllBtn" >View All Package &nbsp;
                        <i class="fa fa-angle-right " aria-hidden="true"></i>
                    </a>
                </div>
            </div>
    ...
    <!-- Trusted Section -->
    <section style="background: #f7f7f7;padding: 0 0 4rem 0">
                ...
                <div class="modal-body" id="bodySectionAHP" data-aos="zoom-in" style="background-color:#f1f1f9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3" data-aos="zoom-in">
                            <label for="healthpartnername" class="form-label fw-semi">Service Provider Name <span class="text-primary">*</span></label>
                    ...
                    <button type="submit" class="btn becomepartnerBtn mt-3 ms-2 me-3" id="formsubmitBtn" style="background-color:#019444; color: white;">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
            ...
            <form id="appliedDoctorForm" action="<?php echo e(asset('applied-doctor')); ?>" method="POST" enctype="multipart/form-data">
                <div class="modal-header" style="background-color:#019444;">
                ...
                <div class="modal-body" id="bodySectionDF" style="background-color:#f1f1f9">
                    ...
                    <button type="submit" class="btn mt-3 ms-2 me-3" id="formsubmitBtn" style="background-color:#019444; color: white;">
                        Become a Doctor
                    </button>
                ...
                <div class="modal-footer" style="background-color:#019444; height: 50px;">
                </div>
            </form>
          </div>
        </div>
    ...
    <div class="modal fade" id="sellerRegisterModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer" style="background-color:#019444;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/sathiservice/public_html/resources/views/front/pages/home.blade.php ENDPATH**/ ?>