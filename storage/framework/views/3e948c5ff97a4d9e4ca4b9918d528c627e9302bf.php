<?php $__env->startSection('title'); ?>
    <?php echo e(__('Appointment Wizard | mHealth')); ?>
  ...
  $(function(){
    ...
    $('#completeStepThree').on('click',function(){
      ...
      if(patient_id==null || patient_id == "null"){
        ...
        window.location.href = "<?php echo e(asset('appoint/doctor?date=')); ?>"+date+"&time="+time+"&doctor_id="+doctor_id+"&patient_id="+patient_id;
      }
    });
    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sansarhealth/public_html/resources/views/front/select_patient.blade.php ENDPATH**/ ?>