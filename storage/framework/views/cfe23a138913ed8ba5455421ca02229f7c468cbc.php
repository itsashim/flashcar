                           ...
                           <div class="row">
                              ...
                              <div class="col-sm-4">
                                 <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="appointment_fee" placeholder="Enter Appointment Fee" required>
                                 </div>
                              </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sansarhealth/public_html/resources/views/admin/hospital/create.blade.php ENDPATH**/ ?>