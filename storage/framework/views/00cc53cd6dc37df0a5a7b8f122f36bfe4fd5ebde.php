...
.ch2 {
	background-color: #00be9c !important;
	border-bottom: 1px solid <?=Session::get('text_color')?> !important;
}
...
.chat-home-bottom-mbox span {
    color: <?=Session::get('text_color')?> !important;
}
...
.loader {
	border: 4px solid <?=Session::get('text_color')?> !important;
}

.loader-inner {
	background-color: <?=Session::get('text_color')?> !important;
}
...
.department-part-box {
	background-color: <?=Session::get('lowbackground_box_color')?> !important;
}
...
</style><?php /**PATH /home2/sathiservice/public_html/resources/views/front/cssclass.blade.php ENDPATH**/ ?>