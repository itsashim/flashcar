                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6 p-3">
                            <div class="category_item_wrap">
                                <a
                                    href="<?php echo e(route('categorySlug',$category->slug)); ?>"
                                    class="category_item d-flex justify-content-center align-items-center"
                                >
                                    <img
                                    src="<?php echo e(asset("public{$category->image}")); ?>"
                                    />
                                    <p><?php echo e($category->name); ?></p></a
                                >
                            </div>
                        </div>
...
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wheelonpalm.com/public_html/resources/views/front/categories.blade.php ENDPATH**/ ?>