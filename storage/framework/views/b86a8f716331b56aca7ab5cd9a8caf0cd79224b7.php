    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav container">
        ...
        <li class="nav-item <?php if($page=="myappointments"): ?> active <?php endif; ?>">
          <a class="nav-link" href="<?php echo e(asset('myappointments')); ?>">Appointment Histories</a>
        </li>
        <li class="nav-item <?php if($page=="mypatients"): ?> active <?php endif; ?>">
          <a class="nav-link" href="<?php echo e(asset('mypatients')); ?>">Patients List</a>
        </li>
        ...
        <li class="nav-item <?php if($page=="myprescriptions"): ?> active <?php endif; ?>">
          <a class="nav-link" href="<?php echo e(asset('myprescriptions')); ?>">My Prescriptions History</a>
        </li>
...
</nav><?php /**PATH /home/sansarhealth/public_html/resources/views/front/members/membernav.blade.php ENDPATH**/ ?>