   ...
   <div class="col-sm-4">
      <div class="page-header float-left">
         <div class="page-title">
            <h1><?php echo e(__('Patient List')); ?></h1>
         </div>
      </div>
   </div>
   <div class="col-sm-8">
         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-body">
                  ...
                  <?php endif; ?>
                  <div>
                     <a href="<?php echo e(url('admin/customer/create')); ?>" class="btn btn-primary"><?php echo e(__('messages.Add').' Patient'); ?></a>
                  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sansarhealth/public_html/resources/views/admin/customer/show.blade.php ENDPATH**/ ?>