      ...
      <div class="page-header float-right">
         <div class="page-title">
            <ol class="breadcrumb text-right">
               <li><a href="<?php echo e(url('admin/doctor')); ?>">Car</a></li>
                        ...
                        <form action="<?php echo e(route('services.store')); ?>" method="post"  enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <input type="text" id="name" placeholder="Enter Car Name" class="form-control" required name="name" value="<?php echo e(isset($data->name)?$data->name:''); ?>" >
                              </div>
                           </div>
                           ...
                           <div class="form-group">
                              <h3 class="mb-4 text-center">Car Rental Fee</h3>
                              <div class="col-md-4">
                                 <label for="daily_fee" class=" form-control-label">
                                 <?php echo e(__('Service Charge Daily')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="daily_fee" placeholder="<?php echo e(__('messages.Enter').' '.__('Daily Fee')); ?>" class="form-control" required name="daily_fee" value="<?php echo e(isset($data->daily_fee)?$data->daily_fee:''); ?>" >
                              </div>
                              <div class="col-md-4">
                                 <label for="phone" class=" form-control-label">
                                 <?php echo e(__('Service Charge Weekly')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="weekly_fee" placeholder="<?php echo e(__('messages.Enter').' '.__('Weekly Fee')); ?>" class="form-control" required name="weekly_fee" value="<?php echo e(isset($data->weekly_fee)?$data->weekly_fee:''); ?>" >
                              </div>
                              <div class="col-md-4">
                                 <label for="phone" class=" form-control-label">
                                 <?php echo e(__('Service Charge Monthly')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="monthly_fee" placeholder="<?php echo e(__('messages.Enter').' '.__('Monthky Fee')); ?>" class="form-control" required name="monthly_fee" value="<?php echo e(isset($data->monthly_fee)?$data->monthly_fee:''); ?>" >
                              </div>
                           </div>


                           <div class="form-group">
                              <h3 class="mb-4 text-center">Specs</h3>
                               <div class="col-md-4">
                                 <label for="power" class=" form-control-label">
                                 <?php echo e(__('Power')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="power" placeholder="<?php echo e(__('messages.Enter').' '.__('Power')); ?>" class="form-control" required name="power" value="<?php echo e(isset($data->power)?$data->power:''); ?>" >
                              </div>
                              <div class="col-md-4">
                                 <label for="max_speed" class=" form-control-label">
                                 <?php echo e(__('Max Speed')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="max_speed" placeholder="<?php echo e(__('messages.Enter').' '.__('Max Speed')); ?>" class="form-control" required name="max_speed" value="<?php echo e(isset($data->max_speed)?$data->max_speed:''); ?>" >
                              </div>
                              <div class="col-md-4">
                                 <label for="acceleration" class=" form-control-label">
                                 <?php echo e(__('Acceleration')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="acceleration" placeholder="<?php echo e(__('messages.Enter').' '.__('Acceleration')); ?>" class="form-control" required name="acceleration" value="<?php echo e(isset($data->acceleration)?$data->acceleration:''); ?>" >
                              </div>

                           </div>
                           <div class="form-group">
                               <div class="col-md-4">
                                 <label for="door" class=" form-control-label">
                                 <?php echo e(__('Door')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="door" placeholder="<?php echo e(__('messages.Enter').' '.__('Door')); ?>" class="form-control" required name="door" value="<?php echo e(isset($data->door)?$data->door:''); ?>" >
                              </div>
                              <div class="col-md-4">
                                 <label for="seat" class=" form-control-label">
                                 <?php echo e(__('Seat')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="seat" placeholder="<?php echo e(__('messages.Enter').' '.__('Seat')); ?>" class="form-control" required name="seat" value="<?php echo e(isset($data->seat)?$data->seat:''); ?>" >
                              </div>
                              <div class="col-md-4">
                                 <label for="phone" class=" form-control-label">
                                 <?php echo e(__('Luggage')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="luggage" placeholder="<?php echo e(__('messages.Enter').' '.__('Luggage')); ?>" class="form-control" required name="luggage" value="<?php echo e(isset($data->luggage)?$data->luggage:''); ?>" >
                              </div>
                           ...
                           <div class="form-group">
                               <div class="col-md-4">
                                 ...
                                 <input type="text" id="transmission" placeholder="<?php echo e(__('messages.Enter').' '.__('Transmission')); ?>" class="form-control" required name="transmission" value="<?php echo e(isset($data->transmission)?$data->transmission:''); ?>" >
                              </div>
                              <div class="col-md-4">
                                 <label for="ac" class=" form-control-label">
                                 <?php echo e(__('Ac')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="ac" placeholder="<?php echo e(__('messages.Enter').' '.__('Ac')); ?>" class="form-control" required name="ac" value="<?php echo e(isset($data->ac)?$data->ac:''); ?>" >
                              </div>
                              <div class="col-md-4">
                                 <label for="car_years" class=" form-control-label">
                                 <?php echo e(__('Car Years')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="car_years" placeholder="<?php echo e(__('messages.Enter').' '.__('Car Years')); ?>" class="form-control" required name="car_years" value="<?php echo e(isset($data->car_years)?$data->car_years:''); ?>" >
                              </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shahbazali.website/rental.shahbazali.website/resources/views/admin/doctor/savedoctor.blade.php ENDPATH**/ ?>