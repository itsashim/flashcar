...
<style>
    ...
    <div class="container">
        <form action="<?php echo e(url('updateprofile')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
        <p class="text-success text-center fs-xl text-capitalize">
            Update your profile
        </p>
        <div class="d-flex row mb-5 mx-0">
            <div class="col-lg-2 col-md-4 col-sm-12 ">
                <?php if(Auth::user()->profile_pic): ?>
                    <img style="border: solid green;border-radius: 50%;width: 150px;height: 150px;"
            ...
            <div class="col-lg-2 col-md-4 col-sm-12 ">
                <p class="text-capitalize lg-mx-5 mt-5 fw-bold text-success pro-d"
        ...
        <div class="my-5">
            <p class="text-dark fw-bold fs-xl text-capitalize">Edit profile</p>
            <div class="#">
                <div class="row mx-0">
                    <div class="col-lg-6 col-sm-12 col-md-6">
                        <div class="p-2">
                            <label for="name" class="text-success text-capitalize" style="font-size: 1.3rem">name:</label>
                        ...
                        <div class="p-2">
                            <label for="name" class="text-success text-capitalize" style="font-size: 1.3rem">Address
                                :</label>
                        ...
                        <div class="p-2">
                            <label for="name" class="text-success text-capitalize" style="font-size: 1.3rem">Phone
                                Number :</label>
                        ...
                        <div class="p-2">
                            <label for="name" class="text-success text-capitalize" style="font-size: 1.3rem">Email
                                :</label>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="p-2">
                            <label for="name" class="text-success text-capitalize" style="font-size: 1.3rem">city
                                :</label>
                        ...
                        <div class="p-2">
                            <label for="name" class="px-2 text-success text-capitalize" style="font-size: 1.3rem">Zip
                                Code :</label>
                        ...
                        <div class="p-2">
                            <label for="name" class="text-success text-capitalize" style="font-size: 1.3rem">Password: <span style="color: green; font-size:12px;">(Enter only if change is needed)</span> </label>
                        ...
                        <div class="p-2">
                            <label for="name" class="text-success text-capitalize" style="font-size: 1.3rem">Confirm
                                Password :</label>
...
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/sathiservice/public_html/resources/views/front/members/myaccount.blade.php ENDPATH**/ ?>