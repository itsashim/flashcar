                ...
                <div class="card">
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Patient Name</th>
                                <th><?php echo e($appointment->patient->first_name); ?> <?php echo e($appointment->patient->last_name); ?> </th>
                            </tr>
                            <tr>
                                <th>Age</th>
                                <th><?php echo e($appointment->patient->age); ?></th>
                            </tr>
                            <tr>
                                <th>DOB</th>
                                <th><?php echo e($appointment->patient->dob); ?></th>
                            </tr>
                            <tr>
                                <th>Gender</th>
                                <th><?php echo e($appointment->patient->gender); ?></th>
                            </tr>
                            <tr>
                                <th>Location</th>
                                <th><?php echo e($appointment->patient->location); ?></th>
                            </tr>
                            <tr>
                                <th>Relation</th>
                                <th><?php echo e($appointment->patient->relation); ?></th>
                            </tr>
                            <tr>
                                <th>Phone</th>
                                <th><?php echo e($appointment->patient->phone); ?></th>
                            </tr>
                            <tr>
                                <th>Email</th>
                                <th><?php echo e($appointment->patient->email); ?></th>
                            </tr>
                            <tr>
                                <th>Address</th>
                                <th><?php echo e($appointment->patient->address); ?></th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sansarhealth/public_html/resources/views/admin/appointment/detail.blade.php ENDPATH**/ ?>