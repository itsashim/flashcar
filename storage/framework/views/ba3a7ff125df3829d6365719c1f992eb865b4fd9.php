                                                    ...
                                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                    ...
                                                                    <a href="<?php echo e(url('admin/saveservice/').'/'.$d->id); ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>

                                                                    <a href="javascript:deleterow('deleteservice','<?= $d->id ?>')" class="btn btn-danger"><i class="fa fa-trash text-white"></i></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sansarhealth/public_html/resources/views/admin/service/default.blade.php ENDPATH**/ ?>