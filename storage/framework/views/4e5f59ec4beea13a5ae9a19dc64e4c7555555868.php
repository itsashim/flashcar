<?php $__env->startSection('title', 'Book Service'); ?>
            ...
            <div class="modal-content">
                <form action="<?php echo e(asset('cod/confirm')); ?>" method="POST">
                    ...
                    <div class="modal-footer">
                        <input style="display: none;" type="text" name="patient_id" value="" />
...
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shahbazali.website/wheelonpalms.shahbazali.website/resources/views/front/pages/bookhospital_step4.blade.php ENDPATH**/ ?>