                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item main-nav-item-sm active">
                            <a class="nav-link main-nav-link-item" href="<?php echo e(url('/')); ?>">Home<span
                                    class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item main-nav-item-sm">
                            <a class="nav-link main-nav-link-item" href="<?php echo e(url('department')); ?>">Category <span
                                    class="sr-only">(current)</span></a>
                        </li>
                        
                        <li class="nav-item main-nav-item-sm">
                            <a class="nav-link main-nav-link-item" href="<?php echo e(route('user.services')); ?>"> Services <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item main-nav-item-sm">
                            <a class="nav-link main-nav-link-item" href="<?php echo e(url('product-list')); ?>">Product<span
                                    class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item main-nav-item-sm">
                            <a class="nav-link main-nav-link-item" href="<?php echo e(url('about-us')); ?>">About Us<span
                                    class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item main-nav-item-sm">
                            <a class="nav-link main-nav-link-item" href="<?php echo e(url('contact_us')); ?>">Contact Us<span
                                    class="sr-only">(current)</span></a>
                        </li>
                        <!--<li class="nav-item main-nav-item-sm">-->
                        ...
                        <li class="nav-item main-nav-item-sm">
                            <div
                                ...
                                <a class="nav-link main-nav-link-item" href="<?php echo e(asset('cart')); ?>"
                                    style="background-color: #019444;border-radius: 50%;width: 46px;margin: 0px 5px 0px 5px;">
                                    <span>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary" type="submit"
                                                style="background-color: #019444;color: white;border-radius: 0 10px 10px 0;">
            ...
            <div class="container">
                <div class="footer-part-main-box">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="footer-r1-box">
                                <div class="footer-logo-box">
                                    <img src="<?php echo e(asset('public/upload/images/wheelsonpalmOld.jpeg')); ?>">
                                </div>
                                    ...
                                    <div class="footer-d1-box">
                                        ...
                                        <p>
                                            <a class="btn directing-page" href="mailto:matinsoftech@gmail.com"
                                                ...
                                                <span>
                                                    <img src="https://wheelsonpalm.com/public/front/img/mail.png">
                                                </span>
                                        ...
                                        <p>
                                            <a class="btn directing-page" href="tel:+977 9800971310"
                                                style="display:flex; gap:10px">
                                                <span>
                                                    <img src="https://wheelsonpalm.com/public/front/img/phone.png">
                                                </span>
                                                +977 9800971310
                                            </a>
                                        </p>
                        ...
                        <div class="col-lg-2 col-md-3">
                            <div class="footer-r1-box">
                                <div class="footer-r1-detail">
                                    <div class="footer-d1-box">
                                        <h3>Categories</h3>
                                        <a href="<?php echo e(url('categoriesPage')); ?>">Cooking
                                            Department</a>
                                        <a href="<?php echo e(url('categoriesPage')); ?>">Cleaning
                                            Department</a>
                                        <a href="<?php echo e(url('categoriesPage')); ?>">Care Taker Department</a>
                                        <!--<a href="https://wheelsonpalm.com/find-doctor?department_id=4">Dental-->
                                        <!--    Department</a>-->
                                        <!--<a href="https://wheelsonpalm.com/find-doctor?department_id=18">abacadada-->
                                        <!--    Department</a>-->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="footer-r1-box">
                                <div class="footer-r1-detail">
                                    <div class="footer-d1-box">
                                        ...
                                        <a href="https://wheelsonpalm.com/termcondition">Terms &amp; Condition</a>
                                        <a href="https://wheelsonpalm.com/privacypolicy">Privacy Policy</a>
                                ...
                                <div class="footer-r1-detail">
                                    <div class="footer-d1-box">
                                         <h3>Like us on Facebook</h3>
                                             <div id="fb-root"></div>
                                              <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v14.0&appId=2197720157033522&autoLogAppEvents=1" nonce="1FOuIuv9"></script>
                                             <div class="fb-page" data-href="https://www.facebook.com/matinsoftech/" data-tabs="timeline" data-width="" data-height="250" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/matinsoftech/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/matinsoftech/">MATIN softech</a></blockquote></div>
                    
                                    </div>
                                </div>
                            </div>
                        </div>
                  <!--        <div class="col-lg-4 col-sm-4 footer-blog-">-->
                  ...
                  <!--</div>-->
                        ...
                        <!--            <div class="footer-d1-box">-->
                        <!--                <h3>Quick Links</h3>-->
                        <!--                <a href="https://wheelsonpalm.com/admin">Seller's Dashboard</a>-->
                        <!--                <a href="https://wheelsonpalm.com/admin">Doctor's Dashboard</a>-->
                        <!--                <a href="https://wheelsonpalm.com/admin">Hospital's Dashboard</a>-->
                        <!--            </div>-->
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/6.1.8/index.global.min.js" integrity="sha512-R2ktoX0ULWEVnA5+oE1kuNEl3KZ9SczXbJk4aT7IgPNfbgTqMG7J14uVqPsdQmZfyTjh0rddK9sG/Mlj97TMEw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>    <!-- bootstrap cdn -->
...
<?php /**PATH /home/shahbazali.website/wheelonpalms.shahbazali.website/resources/views/front/layout/front.blade.php ENDPATH**/ ?>