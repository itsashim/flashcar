...
<!-- Category Section -->
    ...
    <section class="categories_sec container">
      <div class="categories_wrapper pb-0">
        ...
        <div
          class="categories owl-carousel owl-theme owl-carousel_prev_next d-flex flex-wrap justify-content-center justify-content-md-start"
          id="owl-demo2"
        >
        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="item mt-4  mr-md-5  p-5">
            <div class="categories_img_div d-flex">
                <a class="d-flex justify-content-center align-items-center"  href="<?php echo e('https://sathiservice.com/departmentlist?department_id='.$department-> id); ?>">
              <img
         ...
         <div class="container">
            <div class="carousel-wrap normalCarousel">
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="item">
                        <a class="our_service" href="<?php echo e(route('services.find', ['id' => $doctor->id])); ?>">
                            <?php if($doctor->image): ?>
                        ...
                        <span class="img-text text-center">
                            ...
                            <a href="<?php echo e(route('services.find', ['id' => $doctor->id])); ?>" class="btn form-control" style="color:#000; background-color: #019444; color:#fff;">Book Now</a>
                        </span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shahbazali.website/wheelonpalms.shahbazali.website/resources/views/front/pages/home.blade.php ENDPATH**/ ?>