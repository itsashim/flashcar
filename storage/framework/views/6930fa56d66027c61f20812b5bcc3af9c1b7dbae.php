                                    ...
                                    <td class="text-left">
                                        <div>
                                            ...
                                            <?php if($cartDetail->product->offer_price): ?>
                                                <small class="small"><span style="text-decoration: line-through;color:red;">Rs. <?php echo e($cartDetail->product->price); ?></span> <span class="ms-2" style="color:#20748f;font-size:16px;">Rs. <?php echo e($cartDetail->product->offer_price); ?></span> </small>
                                            <?php else: ?>
...
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wheelonpalm.com/public_html/resources/views/front/cart.blade.php ENDPATH**/ ?>