      ...
      <div class="page-header float-right">
         <div class="page-title">
            <ol class="breadcrumb text-right">
               <li class="active"><?php echo e(__('Bike ')); ?></li>
            </ol>
         </div>
      </div>
   </div>
                    ...
                    <table id="service" class="table  table-striped table-bordered">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><?php echo e($d->bikebrand->name); ?></td>
                           <td><?php echo e($d->bikemodels->name); ?></td>
                           <td><?php echo e($d->register_no); ?></td>
                           <td>
                              <div class="btn-group" role="group">
                                 
                                 
                                    <a data-url="<?php echo e(route('bike.destroy',[$d->id])); ?>" data-id="<?php echo e($d->id); ?>" class="btn btn-danger rowDelete">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wheelonpalm.com/public_html/resources/views/admin/bike/index.blade.php ENDPATH**/ ?>