      ...
      <aside id="left-panel" class="left-panel">
         <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="<?php echo e(url('admin/dashboard')); ?>">Sansar Health</a>
               <a class="navbar-brand hidden" href="<?php echo e(url('admin/dashboard')); ?>">SH</a>
            </div>
            <div id="main-menu" class="main-menu collapse navbar-collapse admin-main-menu">
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="menu-icon fa fa-table"></i>Hospital</a>
                     <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/hospital-approved')); ?>">Approved Hospital</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/hospital-appointment')); ?>">Hospital Appointments</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/hospital-pending')); ?>">Pending hospitals </a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/hospital-disabled')); ?>">Rejected hospitals  </a></li>
                     </ul>
                  </li>
                  <?php endif; ?>
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="menu-icon fa fa-table"></i>Doctor</a>
                     <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/doctor-approved')); ?>">Doctors</a></li>
                        
                         <?php if(Auth::user()->usertype == '2'): ?>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/doctor-pending')); ?>">Pending Doctors </a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/doctor-disabled')); ?>">Rejected Doctors  </a></li>
                        <?php endif; ?>
                     </ul>
                  </li>
                  <?php endif; ?>
                  ...
                  <li class="active">
                     <a href="<?php echo e(url('admin/prescription')); ?>"> <i class="menu-icon fa fa-user"></i><?php echo e(__('Prescription')); ?></a>
                  </li>
                  <?php endif; ?>
                ...
                <?php endif; ?>
                 ...
                 <?php if(Auth::user()->usertype == "2"): ?>
                  ...
                  <li class="active">
                     <a href="<?php echo e(url('admin/role')); ?>"> <i class="menu-icon fa fa-cogs"></i><?php echo e(__('Roles and Permissions')); ?></a>
                  </li>
                  <?php endif; ?>
...
</html><?php /**PATH /home/sansarhealth/public_html/resources/views/admin/layout.blade.php ENDPATH**/ ?>