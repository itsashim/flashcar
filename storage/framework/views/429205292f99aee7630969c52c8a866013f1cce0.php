              ...
              <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                            ...
                            ?>
                            <img src="<?php echo e(asset('public/storage/' . $image->image_path)); ?>" class="p-2 d-block w-100" width="300px" height="400px"/>
                    </div>
                    <?php $__currentLoopData = $productGalleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productGallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="carousel-item">
                           <?php if($productGallery->image_path): ?>
                                <img src="<?php echo e(asset('public/storage/' . $productGallery->image_path)); ?>"
                                    datasrc="<?php echo e(asset('public/storage/' . $productGallery->image_path)); ?>" alt="<?php echo e($product->name); ?>"
                                    title="<?php echo e($product->name); ?>" class="p-2 d-block w-100" onclick="clickOtherThumbnails()" width="300px" height="400px"/> 
                            <?php endif; ?>
                        </div>
 ...
 <!--new curosel end -->
            ...
            <div class="overview col-md-6 col-12 mt-3">
                <div class="text-center">
                    ...
                    <h6 class="price">Price: <span style="text-decoration:line-through;color:red;">Rs.<?php echo e($product->price); ?></span> <span style="font-size:20px;color:green;">Rs. <?php echo e($product->offer_price); ?></span> </h6>
                    <?php else: ?>
                    <h6 class="price">Price: <span>Rs.<?php echo e($product->price); ?></span></h6>
                    <?php endif; ?>

                    <div class="action">
                        <button class="add-to-cart btn btn-default add_to_cart" data-id="<?php echo e($product->id); ?>"
                            type="button">
                            Add to cart
                        </button>
                        <button class="like btn btn-default add_to_wishlist" data-id="<?php echo e($product->id); ?>" type="button">
                        ...
                        <h2><?php echo e(__('messages.Login')); ?></h2>
                          <div class="part-form-main-box">
                            <form action="<?php echo e(asset('user/login')); ?>" method="POST">
                                ...
                                <input type="password" id="password" name="password" placeholder="<?php echo e(__('messages.Enter Your Password')); ?>">
    ...
    <div id="quoteModal" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form action="<?php echo e(route('front.quote.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <input style="display: none;" type="text" name="product_id" value="<?php echo e($product->id); ?>" />
...
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shahbazali.website/wheelonpalms.shahbazali.website/resources/views/front/productdetails.blade.php ENDPATH**/ ?>