                        ...
                        <form action="<?php echo e(url('admin/updatedoctorprofile')); ?>" method="post"  enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <input type="text" id="password" placeholder="<?php echo e(__('messages.Enter').' '.__('messages.Password')); ?>" class="form-control" <?php if(isset($data->id)): ?> <?php else: ?> required <?php endif; ?> name="password" >
                              </div>
                           </div>
                           ...
                           <div class="form-group">
                              <div class="col-md-6">
                                 <label for="phone" class=" form-control-label">
                                 <?php echo e(__('Appointment Fee')); ?>

                                 <!--<span class="reqfield" >*</span>-->
                                 </label>
                                 <input type="text" id="appointmentFee" placeholder="<?php echo e(__('messages.Enter').' '.__('Appointment Fee')); ?>" class="form-control" required name="appointment_fee" value="<?php echo e(isset($data->appointment_fee)?$data->appointment_fee:''); ?>" >
                              </div>
                              <div class="col-md-6">
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-6">
                                 ...
                                 <input type="text" id="experience" placeholder="<?php echo e(__('messages.Enter').' '.__('Experience')); ?>" class="form-control" required name="experience" value="<?php echo e(isset($data->experience)?$data->experience:''); ?>" >
                              </div>
                              <div class="col-md-6">
                              </div>
                           </div>
                           ...
                           <div class=" col-md-12 form-group">
                            ...
                            <div class="col-md-12 form-group">
                              <label for="city_id" class=" form-control-label">
                                   <?php echo e(__('select.city')); ?><span class="reqfield" >*</span>
                                   </label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sansarhealth/public_html/resources/views/admin/doctor/savedoctor.blade.php ENDPATH**/ ?>