                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="service" class="table table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th><?php echo e(__('messages.Token')); ?> <?php echo e(__('messages.Number')); ?></th>
                                       ...
                                       <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td style="display: flex; gap: 5px; align-items: center;">
                                                    <a href="<?php echo e(route('appointment.detail',$d->id)); ?>" class="btn btn-sm btn-success">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <?php if($d->status==3): ?>
                                                        <a href="#" data-app_id="<?php echo e($d->id); ?>" data-status="<?php echo e($d->status); ?>" class="btn btn-primary appointment_status"><?php echo e(__('messages.Approve')); ?></a>
                                                    <?php elseif($d->status==6): ?>
                                                        <a href="#" data-app_id="<?php echo e($d->id); ?>" data-status="<?php echo e($d->status); ?>" class="btn btn-primary appointment_status"><?php echo e(__('messages.Reject')); ?></a>
                                                    <?php elseif($d->status==0): ?>
                                                        <a href="#" data-app_id="<?php echo e($d->id); ?>" data-status="<?php echo e($d->status); ?>" class="btn btn-primary appointment_status"><?php echo e(__('messages.Absent')); ?></a>
                                                    <?php elseif($d->status==1): ?>
                                                        <a href="#" data-app_id="<?php echo e($d->id); ?>" data-status="<?php echo e($d->status); ?>" class="btn btn-primary appointment_status"><?php echo e(__('messages.Receive')); ?></a>
                                                    <?php elseif($d->status==2): ?>
                                                        <a href="#" data-app_id="<?php echo e($d->id); ?>" data-status="<?php echo e($d->status); ?>" class="btn btn-primary appointment_status"><?php echo e(__('messages.Reschedule')); ?></a>
                                                    <?php elseif($d->status==4): ?>
                                                        <a href="#" data-app_id="<?php echo e($d->id); ?>" data-status="<?php echo e($d->status); ?>" class="btn btn-primary appointment_status"><?php echo e(__('messages.Complete')); ?></a>
                                                    <?php elseif($d->status==5): ?>
                                                        <a href="#" data-app_id="<?php echo e($d->id); ?>" data-status="<?php echo e($d->status); ?>" class="btn btn-primary appointment_status"><?php echo e(__('messages.Refer Doctor')); ?></a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shahbazali.website/wheelonpalms.shahbazali.website/resources/views/admin/appointment/default.blade.php ENDPATH**/ ?>