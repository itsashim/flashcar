            ...
            <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="doctor-card col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="shadow py-4 mb-2 doctor__card" style="border-radius: 12px;">
                        ...
                        <p class="text-center text-capitalize mt-2" style="font-size: 1.5rem;line-height: 1.2;font-weight: 500;color: #00a042;">
...
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shahbazali.website/wheelonpalms.shahbazali.website/resources/views/front/pages/doctorlist.blade.php ENDPATH**/ ?>