                            ...
                            <div class="tab-appointment-detail-box tab-subcription-detail-box">
                                ...
                                <?php if($s->status == '1'): ?>
                                    ...
                                    <a href="javascript:void(0)" style=";float: right;position: absolute;top: 0;right: 0;padding: 10px;margin-top: 36px;
                                        margin-right: 25px;" class="badge badge-success"><?php echo e(__('messages.Receive')); ?></a>
                                ...
                                <?php elseif($s->status == '2'): ?>
                                    ...
                                    <a href="javascript:void(0)" style="float: right;position: absolute;top: 0;right: 0;padding: 10px;margin-top: 36px;
                                        margin-right: 25px;" class="badge badge-success"><?php echo e(__('messages.Accept')); ?></a>
                                <?php elseif($s->status == '3'): ?>
                                    <!--<a href="<?php echo e(asset('subscription/'.$s->package_id)); ?>" style="display:none; float: right;position: absolute;top: 0;right: 0;padding: 10px;margin-top: 36px;-->
                                    <!--    margin-right: 45px;" class="badge badge-success"><?php echo e(__('messages.Cancel')); ?></a>-->
                                        
                                    <a href="javascript:void(0)" style="float: right;position: absolute;top: 0;right: 0;padding: 10px;margin-top: 36px;
                                        margin-right: 25px;" class="badge badge-success"><?php echo e(__('messages.Cancel')); ?></a>
                                <?php elseif($s->status == '4'): ?>
                                    <!--<a href="<?php echo e(asset('subscription/'.$s->package_id)); ?>" style="display:none; float: right;position: absolute;top: 0;right: 0;padding: 10px;margin-top: 36px;-->
                                    <!--    margin-right: 45px;" class="badge badge-success"><?php echo e(__('messages.In progress')); ?></a>-->
                                        
                                    <a href="javascript:void(0)" style="float: right;position: absolute;top: 0;right: 0;padding: 10px;margin-top: 36px;
                                        margin-right: 25px;" class="badge badge-success"><?php echo e(__('messages.In progress')); ?></a>
                                <?php elseif($s->status == '5'): ?>
                                    <a href="<?php echo e(asset('subscription/'.$s->package_id)); ?>" style="display:none; float: right;position: absolute;top: 0;right: 0;padding: 10px;margin-top: 36px;
                                        margin-right: 25px;" class="badge badge-success"><?php echo e(__('messages.Complete')); ?></a>
                                ...
                                <?php else: ?>
                                    ...
                                    <a href="javascript:void(0)" style="float: right;position: absolute;top: 0;right: 0;padding: 10px;margin-top: 36px;
                                        margin-right: 25px;" class="badge badge-success"><?php echo e(__('messages.Refund')); ?></a>
                                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wheelonpalm.com/public_html/resources/views/front/members/subscription.blade.php ENDPATH**/ ?>