            ...
            <div class="col-sm-6">
                <select class="float-right form-control mb-4 mt-4" id="cityID" style="height: 38px; font-size: 14px;">
                    ...
                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php if(request()->city_id==$city->id): ?> selected="selected" <?php endif; ?> value="<?php echo e($city->id); ?>"><?php echo e($city->name); ?></option>
    ...
    <div class="box-container" id="hospitallistbox">
        ...
        <div class="box">
            <a href="<?php echo e(asset('hospital/'.$hospital->slug)); ?>">
                ...
                <img src="<?php echo e(asset('public'.$hospital->logo)); ?>" alt="">
                <?php else: ?>
                <img src="<?php echo e(asset('public/images/hospital.png')); ?>" alt="" />
                <?php endif; ?>
                <h3><?php echo e($hospital->name); ?></h3>
            </a>
            <span><?php echo e((isset($hospital->city))?$hospital->city->name:$hospital->city_id); ?></span>
            <div class="share">
                <a href="<?php echo e(asset('hospital/'.$hospital->slug)); ?>">Book appointment</a>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sansarhealth/public_html/resources/views/front/hospitalList.blade.php ENDPATH**/ ?>