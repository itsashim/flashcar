      ...
      <div class="categories_wrapper">
        <div class="row mb-3">
                ...
                <div class="col-lg-4 col-md-4 text-lg-right pb-sm-20 pt-3 aos-init aos-animate viewAllDesktop" data-aos="zoom-in">
                    <a href="<?php echo e(asset('categoriesPage')); ?>" class="ViewAllBtn">View All Categories &nbsp;
...
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shahbazali.website/wheelonpalms.shahbazali.website/resources/views/front/categoriesPage.blade.php ENDPATH**/ ?>