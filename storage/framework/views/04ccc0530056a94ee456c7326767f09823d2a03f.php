<div class="row">
    ...
    <div class="col-sm-6">
        <div class="box-light-grey row">
            ...
            <div class="col-sm-6">
                <h4 style="font-weight: 700;">Dr. <?php echo e($doctor->name); ?></h4><br/>
                <i class="fa fa-play"></i> NMC No. <?php echo e($doctor->nmc); ?> <br/>
                <i class="fa fa-play"></i> <?php echo e($doctor->department->name); ?> <br/>
                <i class="fa fa-play"></i> Qualification: <?php echo e($doctor->qualification); ?>  <br/>
...
</div><?php /**PATH /home/sansarhealth/public_html/resources/views/front/ajaxpages/doctor_detail.blade.php ENDPATH**/ ?>