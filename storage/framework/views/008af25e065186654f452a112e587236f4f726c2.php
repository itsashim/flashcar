    ...
    <section class="choose_sec">
      <div class="choose_wrapper">
        <div class="choose_wrapper_left">
          <div>
            <h2 class="heading_two">Why  Choose SathiService?</h2>
            <p>
            Sathi Service is a concept of young and enthusiastic people who are always
            ...
            the service provided. The "Sathi Service" "concept was forwarded by the the
...
<?php echo $__env->make('front.layout.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/sathiservice/public_html/resources/views/front/about-us.blade.php ENDPATH**/ ?>