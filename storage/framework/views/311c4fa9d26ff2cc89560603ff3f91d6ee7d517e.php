  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        ...
        >
          <div class="pic2">
            <img src=" <?php echo e(asset('public/new-images/F.pic.jpg.png')); ?>" />
          </div>
    ...
    <div class="main2 d-flex">
      ...
      <div class="main_main">
        <div class="main d-flex">
          <div class="parent1">
            <div class="Heading">
              ...
              <div class="pic3">
                <img src="<?php echo e(asset('public/new-images/car.jpg.png')); ?>" width="50%" />
              </div>
            </div>

            <div class="pics d-flex">
              <div class="pic4">
                <img src="<?php echo e(asset('public/new-images/car2.jpg.png')); ?>" />
              </div>

              <div class="pic5">
                <img src="<?php echo e(asset('public/new-images/car3.jpg.png')); ?>" />
              </div>

              <div class="pic6">
                <img src="<?php echo e(asset('public/new-images/car4.jpg.png')); ?>" />
              </div>
            </div>
          </div>
          ...
          <div class="parent2">
            <div class="Heading2">
              ...
              <div class="B d-flex">
                <h5>$80.00/day</h5>
                <a href="<?php echo e(url('/billing')); ?>" type="button" class="btn btn-warning">Rent Now</button>
              </div>
            </div>
          </div>
        </div>
        <div class="L">
          ...
          <div class="d-flex">
            <img
              src="<?php echo e(asset('public/new-images/img2.jpg.png')); ?>"
              width="100"
              height="100"
          ...
          <div class="d-flex">
            <img
              src=" <?php echo e(asset('public/new-images/img.jpg.png')); ?> "
              width="100"
              height="100"
              style="border-radius: 50px;"
            />
        ...
        <div class="parent1 d-flex">
          <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h6>Koenigsegg</h6>
              <p>Sport</p>
              <img src="<?php echo e(asset('public/new-images/Sport.jpg.jpg')); ?> " class="card-img-top" alt="..." />
    ...
    <div class="main d-flex justify-content-around">
      <div class="bottom">
        <img src="<?php echo e(asset('public/new-images/Sport.jpg.jpg')); ?> " />
        <p>
...
<?php /**PATH /home/shahbazali.website/rental.shahbazali.website/resources/views/front/demo/review-list.blade.php ENDPATH**/ ?>