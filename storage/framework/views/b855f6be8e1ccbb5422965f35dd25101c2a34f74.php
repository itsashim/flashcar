      ...
      <aside id="left-panel" class="left-panel">
         <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="<?php echo e(url('admin/dashboard')); ?>">WheelsOnPalm</a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse admin-main-menu">
               <ul class="nav navbar-nav">
                  ...
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('city-view')): ?>
                  <li class="active">
                     <a href="<?php echo e(url('admin/city')); ?>"> <i class="menu-icon fa fa-user"></i><?php echo e(__('City')); ?></a>
                  </li>
                  <?php endif; ?>

                  
                  <li class="active">
                     <a href="<?php echo e(url('admin/topadds')); ?>"> <i class="menu-icon fa fa-user"></i>Top Adds</a>
                  </li>
                  ...
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('hospital-view')): ?>
                  <li class="menu-item-has-children dropdown">
                     <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="menu-icon fa fa-table"></i>Service Provider</a>
                     <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="<?php echo e(route('servicesProvider.approved')); ?>">Approved Service Provider</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(route('servicesProvider.appointment')); ?>">Service Provider Appointments</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(route('servicesProvider.pending')); ?>">Pending Service Provider</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(route('servicesProvider.disabled')); ?>">Rejected Service Provider</a></li>
                     </ul>
                  </li>
                  <?php endif; ?>
                  ...
                  <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="<?php echo e(route('services.approved')); ?>">Services</a></li>
                        
                         <?php if(Auth::user()->usertype == '2'): ?>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/service-pending')); ?>">Pending Services </a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/doctor-disabled')); ?>">Rejected Services  </a></li>
                        <?php endif; ?>
                     </ul>
                  </li>
                  <?php endif; ?>

                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('seller-view')): ?>
                  <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-user"></i><a href="<?php echo e(url('admin/applied-seller')); ?>"><?php echo e(__('Applied Seller')); ?></a>
                        </li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/seller?status=approved')); ?>">Approved Sellers</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/seller?status=disabled')); ?>">Rejected Sellers  </a></li>
                     </ul>
                  </li>
                  <?php endif; ?>
                  ...
                  <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/product')); ?>">All Product</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/category')); ?>">Categories</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/sub-category')); ?>">Sub Categories </a></li>
                     </ul>
                  </li>
                  <?php endif; ?>
                  ...
                  <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/bike')); ?>">Added Bike</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/bike-brand')); ?>">Bike Brand</a></li>
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/bike-model')); ?>">Bike Models</a></li>
                     </ul>
                  </li>
                  ...
                  <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="<?php echo e(url('admin/bluebook')); ?>">Bluebook Renew</a></li>
                     </ul>
                  </li>

                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('order-view')): ?>
                  <li class="active">
                     <a href="<?php echo e(url('admin/order')); ?>"> <i class="menu-icon fa fa-user"></i><?php echo e(__('Orders')); ?></a>
                  </li>
                  <?php endif; ?>

                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('seller-view')): ?>
                  <li class="active">
                     <a href="<?php echo e(url('admin/quote')); ?>"> <i class="menu-icon fa fa-user"></i><?php echo e(__('Quote')); ?></a>
                  </li>
                ...
                <?php endif; ?>
                  ...
                  <li class="active">
                     <a href="<?php echo e(url('admin/blog')); ?>"> <i class="menu-icon fa fa-user"></i><?php echo e(__('Blog')); ?></a>
                  </li>
                  <?php endif; ?>
                 ...
                 <?php if(Auth::user()->usertype == "2"): ?>
                   <li class="active">
                     <a href="<?php echo e(url('admin/package')); ?>"> <i class="menu-icon fa fa-user-md"></i>Package</a>
                  </li>
                  <?php endif; ?>
...
</html><?php /**PATH /home/wheelonpalm.com/public_html/resources/views/admin/layout.blade.php ENDPATH**/ ?>